...
![Geoconnex Architecture Diagram](images/fig2.svg){#fig-f1}
...
1. loads the JSON-LD documents into a triple store, which in this case is an instance of [GraphDB](https://graphdb.ontotext.com) with a free license (see @sec-graph for further elaboration on the function and performance of GraphDB).
...
In addition, the vast majority of even highly technical water data analysts are not familiar with SPARQL and should not anticipate
...
#### Discovering and Distinguishing Hydrologically Relevant Observed and Modeled Datasets
